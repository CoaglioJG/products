...
@Module({
    providers: [DeleteProducts, GetProduct,ListProducts,SaveProducts,UpdateProducts,CloneProduct],
    exports: [DeleteProducts, GetProduct,ListProducts,SaveProducts,UpdateProducts,CloneProduct],
  })
